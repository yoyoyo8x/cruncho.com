...
function rendertemplate() {
  ...
  if (listTem) listTem.insertAdjacentHTML("beforeend", eleTem);
}
rendertemplate();
...
function rendertemplate2() {
  ...
  if (listTem2) listTem2.insertAdjacentHTML("beforeend", eleTem2);
}
rendertemplate2();
// /_______________________________________
...
function rendertemplate3() {
  ...
  if (listTem3) listTem3.insertAdjacentHTML("beforeend", eleTem3);
}
rendertemplate3();
